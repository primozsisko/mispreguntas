...
<html lang="en">
 ...
 <h2 class="header center green-text green-lighten-2">About</h2>
<br>
        <div class="container">
            ...
            <div class="row">
                ...
                <p style="text-align: justify">
                    <b>QUIZZER,</b> is a platform that allows us to create questions of test type. With this we can evaluate a series of acquired knowledge, evaluate other people, keep a record of our scores and it also allows us to share these tests with other people of interest, etc.
                    <br><br>
